...
public class DefaultDrive extends CommandBase {
  ...
  public void execute() {
      ...
      double acceleration = m_joystick.getTriggerAxis(Hand.kRight);
      // Getting the value for the left trigger
      double deceleration = m_joystick.getTriggerAxis(Hand.kRight);

      // Getting the hand 
      double turnValue = m_joystick.getX(Hand.kLeft);
